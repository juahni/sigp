...
pg_dump -c prueba -f /home/romina/PycharmProjects/sigp/sigp/dumps/poblacion_prueba.sql -U romina -h localhost -p 5432
pg_dump -c prueba -f /home/romina/PycharmProjects/sigp/sigp/dumps/poblacion_produccion.sql -U romina -h localhost -p 5432
...
echo "**************Ingrese el password del usuario sigp***********************"
psql -U sigp -d sigp-prueba -p 5432 -h localhost < /home/romina/PycharmProjects/sigp/sigp/dumps/poblacion_produccion.sql
...
echo "**************Ingrese el password del usuario sigp***********************"
psql -U sigp -d sigp-prueba -p 5432 -h localhost < /home/romina/PycharmProjects/sigp/sigp/dumps/poblacion_prueba.sql
...
sudo cp -R /home/romina/PycharmProjects/sigp  /var/www/sigp/
