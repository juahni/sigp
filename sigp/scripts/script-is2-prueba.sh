...
pg_dump -c bd-p -U sigp -h localhost -p 5432 > /home/fran/PycharmProjects/sigp/sigp/dumps/poblacion_prueba.sql
pg_dump -c bd-p -U sigp -h localhost -p 5432 > /home/fran/PycharmProjects/sigp/sigp/dumps/poblacion_produccion.sql
...
echo "**************Ingrese el password del usuario sigp***********************"
psql -U sigp -d sigp-prod -p 5432 -h localhost < /home/fran/PycharmProjects/sigp/sigp/dumps/poblacion_produccion.sql
...
echo "**************Ingrese el password del usuario sigp***********************"
psql -U sigp -d sigp-desarrollo -p 5432 -h localhost < /home/fran/PycharmProjects/sigp/sigp/dumps/poblacion_prueba.sql
