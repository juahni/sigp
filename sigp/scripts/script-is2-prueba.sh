...
pg_dump -c bdproduccion -U sigp -h localhost -p 5432 > /home/juahni/PycharmProjects/is2/sigp/dumps/poblacion_prueba.sql
pg_dump -c bdproduccion -U sigp -h localhost -p 5432 > /home/juahni/PycharmProjects/is2/sigp/dumps/poblacion_produccion.sql
...
echo "**************Ingrese el password del usuario sigp***********************"
psql -U sigp -d sigp-prod -p 5432 -h localhost < /home/juahni/PycharmProjects/is2/sigp/dumps/poblacion_produccion.sql
...
echo "**************Ingrese el password del usuario sigp***********************"
psql -U sigp -d sigp-prueba -p 5432 -h localhost < /home/juahni/PycharmProjects/is2/sigp/dumps/poblacion_prueba.sql
...
sudo cp -R /home/juahni/PycharmProjects/is2  /var/www/is2/
