...
urlpatterns = patterns('apps',
                       ...
                       url(r'^proyecto/(?P<pk_proyecto>\d+)/create/$', login_required(views.SprintCreate.as_view()), name='create'),
                       url(r'^proyecto/(?P<pk_proyecto>\d+)/update/(?P<pk_sprint>\d+)/$', login_required(views.SprintUpdate.as_view()), name='update'),
                       url(r'^proyecto/(?P<pk_proyecto>\d+)/backlog/(?P<pk_sprint>\d+)/$', login_required(views.SprintBacklogIndexView.as_view()), name='backlog'),
