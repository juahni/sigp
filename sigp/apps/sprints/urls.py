...
urlpatterns = patterns('apps',
                       ...
                       url(r'^proyecto/(?P<pk_proyecto>\d+)/burndown-chart/(?P<pk_sprint>\d+)/$',
                           'sprints.views.burndown_chart', name='burndown_chart'),
                       url(r'^proyecto/(?P<pk_proyecto>\d+)/finalizar/(?P<pk_sprint>\d+)/$',
                           'sprints.views.finalizar_sprint', name='finalizar'),
                       url(r'^proyecto/(?P<pk_proyecto>\d+)/backlog/(?P<pk_sprint>\d+)/descartar/(?P<pk_user_story>\d+)$',
                           'sprints.views.descartar_user_story', name='descartar'),
