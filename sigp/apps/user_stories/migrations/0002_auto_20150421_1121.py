...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='proyecto',
            field=models.ForeignKey(related_name='proyecto_user_story', to='proyectos.Proyecto', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='userstory',
            name='usuario',
            field=models.ForeignKey(related_name='usuario_user_story', to=settings.AUTH_USER_MODEL, null=True),
            preserve_default=True,
        ),
    ]
